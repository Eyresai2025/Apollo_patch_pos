"""
detect_and_crop_fast.py
------------------------
Adapter: exposes the fast, taught-recipe R-detection (r_locator_fast) using
...
def detect_r_bands_fast(
    ...
    if scale != 1:
        ...
        scaled_recipe = replace(
            recipe,
            band_cols=(recipe.band_cols[0] // scale, recipe.band_cols[1] // scale),
            expected_center=(recipe.expected_center[0] // scale, recipe.expected_center[1] // scale),
