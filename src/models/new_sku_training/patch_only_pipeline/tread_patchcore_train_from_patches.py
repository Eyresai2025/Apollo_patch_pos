"""
Tread patch-only training

Patch-only PatchCore training for tread.

Edit PATCH_FOLDER and OUT_MODEL_PATH, then run:

    python tread_patchcore_train_from_patches.py
...
PATCH_FOLDER = Path(
    r"C:/CHANGE_ME/tread/patches_rtor1"
)

OUT_MODEL_PATH = Path(
    r"C:/CHANGE_ME/models/tread_patchcore_model.pth"
)
