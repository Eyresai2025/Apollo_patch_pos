"""
Sidewall 1 patch-only training

Patch-only PatchCore training for sidewall1.

Edit PATCH_FOLDER and OUT_MODEL_PATH, then run:

    python sidewall1_patchcore_train_from_patches.py
...
PATCH_FOLDER = Path(
    r"C:/CHANGE_ME/sidewall1/patches_rtor1"
)

OUT_MODEL_PATH = Path(
    r"C:/CHANGE_ME/models/sidewall1_patchcore_model.pth"
)
