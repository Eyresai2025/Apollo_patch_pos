"""
Bead patch-only training

Patch-only PatchCore training for bead.

Edit PATCH_FOLDER and OUT_MODEL_PATH, then run:

    python bead_patchcore_train_from_patches.py
...
PATCH_FOLDER = Path(
    r"C:/CHANGE_ME/bead/patches_rtor1"
)

OUT_MODEL_PATH = Path(
    r"C:/CHANGE_ME/models/bead_patchcore_model.pth"
)
