"""
Inner patch-only training

Patch-only PatchCore training for inner.

Edit PATCH_FOLDER and OUT_MODEL_PATH, then run:

    python inner_patchcore_train_from_patches.py
...
PATCH_FOLDER = Path(
    r"C:/CHANGE_ME/inner/patches_rtor1"
)

OUT_MODEL_PATH = Path(
    r"C:/CHANGE_ME/models/inner_patchcore_model.pth"
)
