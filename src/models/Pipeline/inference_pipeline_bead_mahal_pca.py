...
def load_runtime(
    ...
    """
    Runtime loader for bead Live inference.

    Important:
    - Bead is a non-R side.
    ...
    if r_detector_override is not None:
        ...
        print("[RUNTIME] shared R-detector received but not used inside bead")
