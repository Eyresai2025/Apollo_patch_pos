...
def test_model_with_patch_analysis(model, test_loader, checkpoint_path='/content/drive/MyDrive/VIT/runs', patch_size=16, stride=16, threshold=0.05, vgg=None, device='cuda'):
    if checkpoint_path:
    ...
    with torch.no_grad():
        for images, _ in test_loader:
            ...
            reconstruction_error = combined_loss(outputs, images,vgg)
            ...
            save_path = f"/content/drive/MyDrive/VIT/runs/batch_{i}.png"
