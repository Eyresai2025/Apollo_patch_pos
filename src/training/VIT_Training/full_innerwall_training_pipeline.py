#!/usr/bin/env python3
"""
Full innerwall pipeline:
1) prepare dataset from raw innerwall images
2) train ViT autoencoder on prepared train/good patches

Place this file in the same folder as:
- prepare_dataset_from_raw_innerwall.py
...
Run:
    python full_innerwall_training_pipeline.py
"""
...
from src.training.VIT_Training import prepare_dataset_raw_innerwall as prep
...
class PipelineConfig:
    ...
    reference_image_path: str = r"C:\Users\eyres\OneDrive - radometech.com\Desktop\Apollo\VIT+Autoencoder_AE\VIT_Training\Reference\ref_innerwall.png"
    ...
    # ---------------- training ----------------
    run_name: str = "innerwall_vit_autoencoder_run_01"
    epochs: int = 1
    batch_size: int = 2
    lr: float = 1e-4
...
def main() -> None:
    ...
    log("[PIPELINE] Full InnerWall pipeline started")
