...
from src.COMMON.db import get_db, save_cycle_metadata, get_inspection_sync_service
...
class MainWindow(QMainWindow):
    ...
    def setup_sidebar(self, main_layout):
        ...
        buttons = [
            ("System Monitor", "test_mode.png", self.open_test_popup, Permission.HARDWARE_TEST),
